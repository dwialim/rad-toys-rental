...
import logo from './../../assets/icon/rad-toys.png';

const Header = () => {
	return(
		<header id="header" className="header style-03 header-dark header-sticky header-transparent">
					...
					<div className="header-middle">
						...
						<div className="header-middle-inner">
								...
								<div className="box-header-nav menu-nocenter">
									<ul id="menu-primary-menu"
										...
										<li id="menu-item-230"
											...
											<a className="kodory-menu-item-title" title="Home" href="/#">Home</a>
										</li>
										<li id="menu-item-228"
										...
										<li id="menu-item-229"
											...
											<a className="kodory-menu-item-title" title="Elements" href="#testimonial">Testimonial</a>
										</li>
										<li id="menu-item-996"
							...
							<div className="header-logo">
								<a href="index.html">
								<img alt="Kodory" src={logo} className="logo" />
								</a>
							</div>
									...
									<div className="meta-dreaming">
											...
											<div className="block-search">
												<form role="search" method="get"
													...
													<div className="form-content search-box results-search">
														<div className="inner">
															<input autoComplete="off" className="searchfield txt-livesearch input"
													...
													<div className="category">
														<select title="product_cat" name="product_cat"
															...
															<option className="level-0" value="Toy">Toys</option>
															<option className="level-0" value="Teddy Bear">Teddy Bear</option>
															<option className="level-0" value="Clothing">Clothing</option>
															<option className="level-0" value="Backpack">Backpack</option>
															<option className="level-0" value="new-arrivals">New arrivals</option>
															<option className="level-0" value="Footwear">Footwear</option>
															<option className="level-0" value="T-shirt">T-shirt</option>
															<option className="level-0" value="Hoodie">Hoodie</option>
														</select>
													</div>
										...
										<div className="menu-item block-user block-dreaming kodory-dropdown">
											...
											<ul className="sub-menu">
												<li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--dashboard is-active">
													<a href="/#">Dashboard</a>
												</li>
												<li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--orders">
													<a href="/#">Orders</a>
												</li>
												<li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--downloads">
													<a href="/#">Downloads</a>
												</li>
												<li className="menu-item kodory-MyAccount-navigation-link kodory-MyAccount-navigation-link--edit-address">
													<a href="/#">Addresses</a>
												</li>
										...
										<div className="block-minicart block-dreaming kodory-mini-cart kodory-dropdown">
											...
											<div className="widget kodory widget_shopping_cart">
												<div className="widget_shopping_cart_content">
													<h3 className="minicart-title">Your Cart<span
															className="minicart-number-items">3</span></h3>
													<ul className="kodory-mini-cart cart_list product_list_widget">
														<li className="kodory-mini-cart-item mini_cart_item">
															...
															<span className="quantity">1 × <span
																	className="kodory-Price-amount amount"><span
																	className="kodory-Price-currencySymbol">$</span>150.00</span></span>
														</li>
														<li className="kodory-mini-cart-item mini_cart_item">
															<a href="/#" className="remove remove_from_cart_button">×</a>
															<a href="/#">
															...
															<span className="quantity">1 × <span
																	className="kodory-Price-amount amount"><span
																	className="kodory-Price-currencySymbol">$</span>129.00</span></span>
														</li>
														<li className="kodory-mini-cart-item mini_cart_item">
															<a href="/#" className="remove remove_from_cart_button">×</a>
															<a href="/#">
															...
															<span className="quantity">1 × <span
																	className="kodory-Price-amount amount"><span
																	className="kodory-Price-currencySymbol">$</span>139.00</span></span>
														</li>
													</ul>
													<p className="kodory-mini-cart__total total"><strong>Subtotal:</strong>
														<span className="kodory-Price-amount amount"><span
																className="kodory-Price-currencySymbol">$</span>418.00</span>
													</p>
													<p className="kodory-mini-cart__buttons buttons">
														<a href="cart.html" className="button kodory-forward">Viewcart</a>
														<a href="checkout.html"
														   className="button checkout kodory-forward">Checkout</a>
													</p>
												</div>
											</div>
										</div>
					...
					<div className="header-search kodory-dropdown">
						...
						<div className="block-search">
							<form role="search" method="get"
								...
								<div className="form-content search-box results-search">
									<div className="inner">
										<input autoComplete="off" className="searchfield txt-livesearch input" name="s"
								...
								<input name="taxonomy" value="product_cat" type="hidden" />
								<div className="category">
									<select title="product_cat" name="product_cat" id="112546160" className="category-search-option"
											tabIndex="-1"
											style={{display: "none"}}>
										<option value="0">All Categories</option>
										<option className="level-0" value="Toy">Toys</option>
							...
							<div className="wcml-dropdown product wcml_currency_switcher">
								<ul>
									<li className="wcml-cs-active-currency">
										<a className="wcml-cs-item-toggle" href="/#">USD</a>
							...
							<div className="block-minicart block-dreaming kodory-mini-cart kodory-dropdown">
								...
								<div className="widget kodory widget_shopping_cart">
									<div className="widget_shopping_cart_content">
										...
										<p className="kodory-mini-cart__buttons buttons">
											<a href="cart.html" className="button kodory-forward">Viewcart</a>
											<a href="checkout.html" className="button checkout kodory-forward">Checkout</a>
										</p>
									</div>
								</div>
							</div>
